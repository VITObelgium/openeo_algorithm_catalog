...
Each algorithm is organized in its own directory within this repository. The structure of each algorithm directory is as follows:
...
│   ├── generate.py     # Main algorithm implementation
